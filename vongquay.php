...
<h3 class="c-center c-font-uppercase c-font-bold">Vòng Quay Mùa Hè 17k</h3>
...
<img style="width: 80%;max-width: 80%;opacity: 1;" src="/storage/images/tQvQyDUZRT_1593087004.png" alt="Play" id="rotate-play">
</div>
...
<a href="/rubywheel/logacc/1265" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
<span>
<i class="la la-cloud-upload"></i>
        ...
        if(angles >= -((num_loop*360)+angle_gift)){
            ...
            else
            {
                ...
                else if(gift_detail.input_auto == 1)
                {
                    ...
                    $("#btnWithdraw").attr('href','/slotmachine/logaccgame/'+1265);
                }
