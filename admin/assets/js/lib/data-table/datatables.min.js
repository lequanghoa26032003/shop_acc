...
"_"+location.pathname,JSON.stringify(b))}catch(c){}},fnStateSaveParams:null,iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": Sắp xếp tăng dần",sSortDescending:": Sắp xếp giảm dần"},oPaginate:{sFirst:"Đầu tiên",sLast:"Cuối cùng",sNext:"Tiếp",sPrevious:"Trước"},sEmptyTable:"Không có dữ liệu",sInfo:"Đang hiển thị _START_ đến _END_ của _TOTAL_ mục",sInfoEmpty:"Đang hiển thị 0 đến 0 từ 0 mục",
sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Hiển thị _MENU_ mục",sLoadingRecords:"Loading...",sProcessing:"Processing...",sSearch:"Search:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Không tìm thấy kết quả"},oSearch:g.extend({},m.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null,rowId:"DT_RowId"};
