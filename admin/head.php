        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <?php if($TMQ['admin'] == 9){ ?>
                     <li class="menu-title">Vòng quay thẻ zing 20K</li><!-- /.menu-title -->
                     <li>
                        <a href="/admin/acc_wheel.php"> <i class="menu-icon fa fa-money"></i>Danh sách thẻ zing</a>
                    </li>
                   <li>
                        <a href="/admin/upacc_wheel.php"> <i class="menu-icon fa fa-money"></i>Thêm thẻ zing</a>
                    </li>
                    
                  <?php } ?>
                  
                  <?php if($TMQ['admin'] == 9){ ?>
                     <li class="menu-title">Vòng quay Code</li><!-- /.menu-title -->
                     <li>
                        <a href="/admin/acc_code.php"> <i class="menu-icon fa fa-money"></i>Danh sách Code</a>
                    </li>
                   <li>
                        <a href="/admin/up_code.php"> <i class="menu-icon fa fa-money"></i>Thêm Code</a>
                    </li>
                    
                  <?php } ?>

<?php if($TMQ['admin'] == 9){ ?>
                     <li class="menu-title">Lật thẻ + vòng quay kim cương</li><!-- /.menu-title -->
                     <li>
                        <a href="/admin/ti-le-lat-the-ff.html"> <i class="menu-icon ti-gift"></i>Tỉ lệ lật thẻ FreeFire</a>
                    </li>
                    <li>
                        <a href="/admin/ti-le-vong-quay-ff.html"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay FreeFire</a>
                    </li>
                    <li>
                        <a href="/admin/setting_wheelzing.php"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay thẻ zing</a>
                    </li>
                    </li>
                    <li>
                        <a href="/admin/setting_wheelcode.php"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay code</a>
                    </li>
                                        </li>
                    </li>
                    <li>
                        <a href="/admin/setting_wheelvk.php"> <i class="menu-icon ti-gift"></i>Tỉ lệ vòng quay vũ khí</a>
                    </li>
...
<?php if($TMQ['admin'] == 9){ ?>
                     <li class="menu-title">Lịch sử Vòng quay + lật thẻ</li><!-- /.menu-title -->
                     <li>
                        <a href="/admin/vongquaythezing.php"> <i class="menu-icon fa fa-history"></i>Vòng quay thẻ zing</a>
                    </li>
                    <li>
                        <a href="/admin/vongquaycode.php"> <i class="menu-icon fa fa-history"></i>Vòng quay code</a>
                    </li>
                    <li>
                        <a href="/admin/lattheff.php"> <i class="menu-icon fa fa-history"></i>Lật thẻ freefire</a>
                    </li>
                    <li>
                        <a href="/admin/vongquayff.php"> <i class="menu-icon fa fa-history"></i>Vòng quay freefire</a>
                    </li>
                    </li>
                    <li>
                        <a href="/admin/vongquayvukhi.php"> <i class="menu-icon fa fa-history"></i>Vòng quay Vũ Khí</a>
                    </li>
                  ...
                  <?php } ?>
                   ...
                   <li>
                    ...
                    <li>
                        <a href="/admin/rutkc.php"> <i class="menu-icon fa fa-diamond"></i>Rút kim cương</a>
                    </li>
                   ...
                   <li>
                     ...
                     <li>
                        <a href="/admin/setting_email.php"> <i class="menu-icon ti-settings"></i>Cấu hình email </a>
                    </li>
                     <li>
        ...
        <header id="header" class="header">
            <div class="top-left">
                <div class="navbar-header">
                    <a class="navbar-brand" href="./"><img width="25%" src="http://tool.caovanhuy.net/logo/hatgiay/view.php?text=ADMIN&color=2" alt="Logo"></a>
                    <a class="navbar-brand hidden" href="./"><img src="https://o.remove.bg/downloads/54957149-6d78-4217-88a9-9027ebd06106/t%E1%BA%A3i_xu%E1%BB%91ng__2_-removebg-preview.png" alt="Logo"></a>
    ...
    <?php } ?></span>
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                   ...
                                   <img class="user-avatar rounded-circle" src="images/avatar/2.jpg" alt="User Avatar">
