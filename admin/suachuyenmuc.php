                              ...
                              <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <textarea name="info1" id="info1" rows="9" placeholder="Thông tin 1" class="form-control"><?=$get['thongtin_1'];?></textarea>
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <textarea name="info2" id="info2" rows="9" placeholder="Thông tin 2" class="form-control"><?=$get['thongtin_2'];?></textarea>
                                    </div>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="input-group">
                                       ...
                                       <textarea name="info3" id="info3" rows="9" placeholder="Thông tin 3" class="form-control"><?=$get['thongtin_3'];?></textarea>
                                    </div>
