...
<div class="breadcrumbs">
    ...
    <?php
    if($TMQ['admin'] == 9){
        $get = $db->query("SELECT * FROM `TMQ_lichsu` ORDER BY id DESC"); //lấy danh sách bài viết theo chuyên mục
    }elseif($TMQ['admin'] == 1){
$get = $db->query("SELECT * FROM `TMQ_lichsu` WHERE `uid_ban` = '$uid' ORDER BY id DESC"); //lấy danh sách bài viết theo chuyên mục
}
while($row = $get->fetch()){
