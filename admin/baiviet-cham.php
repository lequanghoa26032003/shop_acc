			...
			for($i=0;$i<$countfiles;$i++){
			   ...
			   $filename = $_FILES['files']['name'][$i];
          		...
          		if(in_array($ext, $valid_ext)){
          			// Upload file
				   	if(move_uploaded_file($_FILES['files']['tmp_name'][$i],'../upload/anhnick/'.$rowCount.'/'.$filename)){
            $link_img .= "https://$website/upload/anhnick/$rowCount/$filename\n";
                            ...
                            <div class="card-body card-block">
                                ...
                                <div class="col-3">
                                    ...
                                    <label class=" form-control-label">Thông tin</label>
                                        ...
                                        <textarea name="thongtin" id="thongtin" rows="9" width="100%" placeholder="Bắt buộc" class="form-control"></textarea>
                                 ...
                                 <div class="form-group">
                                    <label class=" form-control-label">Hình ảnh</label>
                                        ...
                                        <textarea name="img" id="img" rows="9" width="100%" placeholder="Hình ảnh" class="form-control"></textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="img" id="img" rows="9" width="100%" placeholder="Hình ảnh" class="form-control"></textarea>
                                - OR - 
                                       <input type="file" name="files[]" id="show-image" multiple >
                                  <div id="preview"></div>
                                </div>
                            </div>
                        <button type="submit" class="btn btn-outline-success" name="themsanpham">Thêm</button>
                        </form>
...
document.querySelector('#show-image').addEventListener("change", previewImages);
