...
if(isset($_POST['timkiem'])){
$get = $db->query("SELECT * FROM `TMQ_lichsu` WHERE `uid_mua` = '$uid' ORDER BY id DESC $start $end LIMIT $from,$sotin1trang ");
}else{
$get = $db->query("SELECT * FROM `TMQ_lichsu` WHERE `uid_mua` = '$uid' ORDER BY id DESC  LIMIT $from,$sotin1trang");
}
