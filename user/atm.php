...
<div class="modal-body">
	...
	<tbody>
		<tr>
			<th colspan="2">Chủ tài khoản: Trương Nguyễn Kim Hùng</th>
		...
		<tr>
			...
			<th>Đà Nẵng</th>
                ...
                <div class="tut-charge" style="background-color: #ffffff;padding-top: 15px">
                    <p>Nội dung thanh to&aacute;n:&nbsp;<strong>Nap Tien T&ecirc;n Web</strong>&nbsp;{t&ecirc;n t&agrave;i khoản hoặc ID t&agrave;i khoản}</p>

<p>Chuyển xong li&ecirc;n hệ facebook :&nbsp;<strong><a href="https://www.facebook.com/kimhung365.vn/" target="_blank">Chăm S&oacute;c Kh&aacute;ch H&agrave;ng</a></strong>&nbsp;hoặc Hotline&nbsp;<strong>0904.03.54.34</strong>&nbsp;để được xử l&yacute;.</p>
                </div>
	...
	<tbody>
		<tr>
			...
			<td><strong>cherrykrixi@gmail.com</strong></td>
		</tr>
        <tr>
			<td><strong>KEY24h (key24h.com)</strong></td>
			<td><strong>cherrykrixi@gmail.com</strong></td>
		</tr>
		<tr>
			<td><strong>Momo</strong></td>
			<td><strong>Chưa Hỗ Trợ</strong></td>
		</tr>
		<tr>
